  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl mx-auto rounded-3xl shadow-2xl overflow-hidden bg-gradient-to-tr from-primary via-secondary to-accent p-1">
        <div className="bg-white/95 rounded-[22px] p-10 md:p-16 flex flex-col items-center text-center gap-6">
          <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-2 drop-shadow">
          ...
          <a href="#contact">
            <button className="bg-accent text-primary font-bold py-4 px-10 rounded-full text-lg shadow-xl hover:bg-primary hover:text-white transition duration-200">
              Get Started
            </button>
          </a>
        </div>
