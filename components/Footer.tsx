    ...
    <footer className="bg-gradient-to-tr from-[#273C92] via-[#1e2d64] to-[#33B6FF] py-10 px-4 text-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-10 border-b border-white/10 pb-8">
        ...
        <div className="flex-1 flex flex-col items-center">
          <h3 className="font-bold mb-3 text-[#FBC21C] tracking-wider uppercase text-sm">Quick Links</h3>
        ...
        <div className="flex flex-col items-center md:items-end mt-8 md:mt-0">
          <h3 className="font-bold mb-3 text-[#FBC21C] tracking-wider uppercase text-sm">Contact</h3>
